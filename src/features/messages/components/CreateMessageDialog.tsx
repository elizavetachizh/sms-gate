...
interface CreateMessageDialogFormProps {
  mailingId: string;
  onClose: () => void;
  onSuccess?: (count: number) => void;
}

function CreateMessageDialogForm({
  mailingId,
  onClose,
  onSuccess,
}: CreateMessageDialogFormProps) {
